...
8 / 2382 files match
 ...
 - [giscanner/shlibs.py](#giscannershlibspy)
 - [giscanner/utils.py](#giscannerutilspy)
 - [gir/gmodule-2.0.c](#girgmodule-20c)
...
136 | # library name is suppose to be what you pass to dlopen() (or
{% endraw %}
...
{% raw %}
108 | # Returns the name that we would pass to dlopen() the library
{% endraw %}
...
{% raw %}
86 |  * systems that provide an implementation of dlopen() (e.g. Linux/Sun), as
{% endraw %}
...
2502 |    * For modules with no shared library, we dlopen'd the current
{% endraw %}

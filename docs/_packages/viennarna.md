...
6 / 3329 files match
 ...
 - [src/RNAforester/g2-0.72/configure.ac](#srcrnaforesterg2-072configureac)
 - [src/RNAforester/g2-0.72/autom4te.cache/output.0](#srcrnaforesterg2-072autom4tecacheoutput0)
 - [src/RNAforester/g2-0.72/autom4te.cache/output.1](#srcrnaforesterg2-072autom4tecacheoutput1)
...
```
### src/RNAforester/g2-0.72/configure.ac

```

{% raw %}
52 | AC_CHECK_LIB(dl, dlopen, have_dl=yes, have_dl=no)
{% endraw %}

```
### src/RNAforester/g2-0.72/autom4te.cache/output.0

```

{% raw %}
3666 | { $as_echo "$as_me:${as_lineno-$LINENO}: checking for dlopen in -ldl" >&5
3667 | $as_echo_n "checking for dlopen in -ldl... " >&6; }
3668 | if ${ac_cv_lib_dl_dlopen+:} false; then :
3682 | char dlopen ();
3686 | return dlopen ();
3692 |   ac_cv_lib_dl_dlopen=yes
3694 |   ac_cv_lib_dl_dlopen=no
3700 | { $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_cv_lib_dl_dlopen" >&5
3701 | $as_echo "$ac_cv_lib_dl_dlopen" >&6; }
3702 | if test "x$ac_cv_lib_dl_dlopen" = xyes; then :
{% endraw %}

```
### src/RNAforester/g2-0.72/autom4te.cache/output.1

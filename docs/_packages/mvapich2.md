...
43 / 8321 files match
 ...
 - [src/pm/mpirun/subconfigure.m4](#srcpmmpirunsubconfigurem4)
 ...
 - [src/mpid/ch3/channels/mrail/subconfigure.m4](#srcmpidch3channelsmrailsubconfigurem4)
 ...
 - [src/openpa/confdb/libtool.m4](#srcopenpaconfdblibtoolm4)
 - [src/openpa/confdb/ltoptions.m4](#srcopenpaconfdbltoptionsm4)
 - [src/openpa/confdb/ltmain.sh](#srcopenpaconfdbltmainsh)
 - [limic2-0.5.6/ltmain.sh](#limic2-056ltmainsh)
 - [limic2-0.5.6/aclocal.m4](#limic2-056aclocalm4)
 ...
 - [osu_benchmarks/ltmain.sh](#osu_benchmarksltmainsh)
 - [osu_benchmarks/aclocal.m4](#osu_benchmarksaclocalm4)
...
```
### src/pm/mpirun/subconfigure.m4

```

{% raw %}
177 |               AC_SEARCH_LIBS([dlopen],
{% endraw %}
...
{% raw %}
159 | AM_PROG_LIBTOOL([dlopen win32-dll])
{% endraw %}
...
{% raw %}
1087 |       AC_CHECK_LIB([ltdl], [lt_dlopenext],
1338 |   save_lt_cv_dlopen="$lt_cv_dlopen"
1339 |   save_lt_cv_dlopen_libs="$lt_cv_dlopen_libs"
1340 |   save_lt_cv_dlopen_self="$lt_cv_dlopen_self"
1342 |   # code stolen from LT_SYS_DLOPEN_SELF in libtool.m4
1345 |     lt_cv_dlopen="load_add_on"
1346 |     lt_cv_dlopen_libs=
1347 |     lt_cv_dlopen_self=yes
1351 |     lt_cv_dlopen="LoadLibrary"
1352 |     lt_cv_dlopen_libs=
1356 |     lt_cv_dlopen="dlopen"
1357 |     lt_cv_dlopen_libs=
1362 |     AC_CHECK_LIB([dl], [dlopen],
1363 |                 [lt_cv_dlopen="dlopen" lt_cv_dlopen_libs="-ldl"],[
1364 |     lt_cv_dlopen="dyld"
1365 |     lt_cv_dlopen_libs=
1366 |     lt_cv_dlopen_self=yes
1372 |           [lt_cv_dlopen="shl_load"],
1374 |             [lt_cv_dlopen="shl_load" lt_cv_dlopen_libs="-ldld"],
1375 |         [AC_CHECK_FUNC([dlopen],
1376 |               [lt_cv_dlopen="dlopen"],
1377 |           [AC_CHECK_LIB([dl], [dlopen],
1378 |                 [lt_cv_dlopen="dlopen" lt_cv_dlopen_libs="-ldl"],
1379 |             [AC_CHECK_LIB([svld], [dlopen],
1380 |                   [lt_cv_dlopen="dlopen" lt_cv_dlopen_libs="-lsvld"],
1382 |                     [lt_cv_dlopen="dld_link" lt_cv_dlopen_libs="-ldld"])
1390 |   # end of code stolen from LT_SYS_DLOPEN_SELF in libtool.m4
1393 |   HWLOC_LIBS_PRIVATE="$HWLOC_LIBS_PRIVATE $lt_cv_dlopen_libs"
1396 |   lt_cv_dlopen="$save_lt_cv_dlopen"
1397 |   lt_cv_dlopen_libs="$save_lt_cv_dlopen_libs"
1398 |   lt_cv_dlopen_self="$save_lt_cv_dlopen_self"
{% endraw %}
...
{% raw %}
316 |  * loaded hwloc (e.g. OpenCL implementations using dlopen with RTLD_LAZY).
...
```
### src/mpid/ch3/channels/mrail/subconfigure.m4

```

{% raw %}
498 |     AC_SEARCH_LIBS(dlopen, dl,,[AC_MSG_ERROR(['libdl not found'])])
{% endraw %}
...
{% raw %}
1824 | # _LT_TRY_DLOPEN_SELF (ACTION-IF-TRUE, ACTION-IF-TRUE-W-USCORE,
1827 | m4_defun([_LT_TRY_DLOPEN_SELF],
1885 |   void *self = dlopen (0, LT_DLGLOBAL|LT_DLLAZY_OR_NOW);
1918 | ])# _LT_TRY_DLOPEN_SELF
1921 | # LT_SYS_DLOPEN_SELF
1923 | AC_DEFUN([LT_SYS_DLOPEN_SELF],
1925 | if test yes != "$enable_dlopen"; then
1926 |   enable_dlopen=unknown
1927 |   enable_dlopen_self=unknown
1928 |   enable_dlopen_self_static=unknown
1930 |   lt_cv_dlopen=no
1931 |   lt_cv_dlopen_libs=
1935 |     lt_cv_dlopen=load_add_on
1936 |     lt_cv_dlopen_libs=
1937 |     lt_cv_dlopen_self=yes
1941 |     lt_cv_dlopen=LoadLibrary
1942 |     lt_cv_dlopen_libs=
1946 |     lt_cv_dlopen=dlopen
1947 |     lt_cv_dlopen_libs=
1952 |     AC_CHECK_LIB([dl], [dlopen],
1953 | 		[lt_cv_dlopen=dlopen lt_cv_dlopen_libs=-ldl],[
1954 |     lt_cv_dlopen=dyld
1955 |     lt_cv_dlopen_libs=
1956 |     lt_cv_dlopen_self=yes
1963 |     lt_cv_dlopen=dlopen
1964 |     lt_cv_dlopen_libs=
1965 |     lt_cv_dlopen_self=no
1970 | 	  [lt_cv_dlopen=shl_load],
1972 | 	    [lt_cv_dlopen=shl_load lt_cv_dlopen_libs=-ldld],
1973 | 	[AC_CHECK_FUNC([dlopen],
1974 | 	      [lt_cv_dlopen=dlopen],
1975 | 	  [AC_CHECK_LIB([dl], [dlopen],
1976 | 		[lt_cv_dlopen=dlopen lt_cv_dlopen_libs=-ldl],
1977 | 	    [AC_CHECK_LIB([svld], [dlopen],
1978 | 		  [lt_cv_dlopen=dlopen lt_cv_dlopen_libs=-lsvld],
1980 | 		    [lt_cv_dlopen=dld_link lt_cv_dlopen_libs=-ldld])
1989 |   if test no = "$lt_cv_dlopen"; then
1990 |     enable_dlopen=no
1992 |     enable_dlopen=yes
1995 |   case $lt_cv_dlopen in
1996 |   dlopen)
2004 |     LIBS="$lt_cv_dlopen_libs $LIBS"
2006 |     AC_CACHE_CHECK([whether a program can dlopen itself],
2007 | 	  lt_cv_dlopen_self, [dnl
2008 | 	  _LT_TRY_DLOPEN_SELF(
2009 | 	    lt_cv_dlopen_self=yes, lt_cv_dlopen_self=yes,
2010 | 	    lt_cv_dlopen_self=no, lt_cv_dlopen_self=cross)
2013 |     if test yes = "$lt_cv_dlopen_self"; then
2015 |       AC_CACHE_CHECK([whether a statically linked program can dlopen itself],
2016 | 	  lt_cv_dlopen_self_static, [dnl
2017 | 	  _LT_TRY_DLOPEN_SELF(
2018 | 	    lt_cv_dlopen_self_static=yes, lt_cv_dlopen_self_static=yes,
2019 | 	    lt_cv_dlopen_self_static=no,  lt_cv_dlopen_self_static=cross)
2029 |   case $lt_cv_dlopen_self in
2030 |   yes|no) enable_dlopen_self=$lt_cv_dlopen_self ;;
2031 |   *) enable_dlopen_self=unknown ;;
2034 |   case $lt_cv_dlopen_self_static in
2035 |   yes|no) enable_dlopen_self_static=$lt_cv_dlopen_self_static ;;
2036 |   *) enable_dlopen_self_static=unknown ;;
2039 | _LT_DECL([dlopen_support], [enable_dlopen], [0],
2040 | 	 [Whether dlopen is supported])
2041 | _LT_DECL([dlopen_self], [enable_dlopen_self], [0],
2042 | 	 [Whether dlopen of programs is supported])
2043 | _LT_DECL([dlopen_self_static], [enable_dlopen_self_static], [0],
2044 | 	 [Whether dlopen of statically linked programs is supported])
2045 | ])# LT_SYS_DLOPEN_SELF
2048 | AU_ALIAS([AC_LIBTOOL_DLOPEN_SELF], [LT_SYS_DLOPEN_SELF])
2050 | dnl AC_DEFUN([AC_LIBTOOL_DLOPEN_SELF], [])
...
```
### src/openpa/confdb/ltoptions.m4
...
{% raw %}
165 | AM_PROG_LIBTOOL([dlopen win32-dll])
{% endraw %}
...
{% raw %}
1046 |       AC_CHECK_LIB([ltdl], [lt_dlopenext],
1298 |   save_lt_cv_dlopen="$lt_cv_dlopen"
1299 |   save_lt_cv_dlopen_libs="$lt_cv_dlopen_libs"
1300 |   save_lt_cv_dlopen_self="$lt_cv_dlopen_self"
1302 |   # code stolen from LT_SYS_DLOPEN_SELF in libtool.m4
...
1324 |     lt_cv_dlopen="dyld"
1325 |     lt_cv_dlopen_libs=
1326 |     lt_cv_dlopen_self=yes
1332 |           [lt_cv_dlopen="shl_load"],
1334 |             [lt_cv_dlopen="shl_load" lt_cv_dlopen_libs="-ldld"],
1335 |         [AC_CHECK_FUNC([dlopen],
1336 |               [lt_cv_dlopen="dlopen"],
1337 |           [AC_CHECK_LIB([dl], [dlopen],
1338 |                 [lt_cv_dlopen="dlopen" lt_cv_dlopen_libs="-ldl"],
1339 |             [AC_CHECK_LIB([svld], [dlopen],
1340 |                   [lt_cv_dlopen="dlopen" lt_cv_dlopen_libs="-lsvld"],
1342 |                     [lt_cv_dlopen="dld_link" lt_cv_dlopen_libs="-ldld"])
1350 |   # end of code stolen from LT_SYS_DLOPEN_SELF in libtool.m4
1353 |   HWLOC_LIBS_PRIVATE="$HWLOC_LIBS_PRIVATE $lt_cv_dlopen_libs"
1356 |   lt_cv_dlopen="$save_lt_cv_dlopen"
1357 |   lt_cv_dlopen_libs="$save_lt_cv_dlopen_libs"
1358 |   lt_cv_dlopen_self="$save_lt_cv_dlopen_self"
{% endraw %}

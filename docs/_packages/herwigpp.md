...
6 / 2260 files match
 ...
 - [src/Herwig++.cc](#srcherwig++cc)
 - [Contrib/Analysis2/configure.ac](#contribanalysis2configureac)
...
{% raw %}
87 | LT_INIT([disable-static dlopen pic-only])
{% endraw %}
...
{% raw %}
92 |     // Library search path for dlopen()
{% endraw %}

```
### Contrib/Analysis2/configure.ac

```

{% raw %}
42 | dnl LT_INIT([disable-static dlopen pic-only])
{% endraw %}

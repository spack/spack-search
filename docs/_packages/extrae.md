...
{% raw %}
176 | AC_LIBTOOL_DLOPEN
184 | AC_CHECK_LIB(dl, dlopen, have_dl=yes, have_dl=no)
{% endraw %}
...
{% raw %}
108 | 	# CUDA is superseded by CUPTI. If CUPTI is available, use it instead dlopen alternative.
{% endraw %}

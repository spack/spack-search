...
{% raw %}
40 |       dlopen(NULL,RTLD_NOW|RTLD_GLOBAL);
125 |     hnd=dlopen(nm.text(),RTLD_NOW|RTLD_GLOBAL);
240 |     return FXDLL(dlopen(info.dli_fname,RTLD_NOLOAD|RTLD_NOW|RTLD_GLOBAL));
{% endraw %}

...
7 / 540 files match
 ...
 - [config/ac_dll.m4](#configac_dllm4)
 - [config/libtool.m4](#configlibtoolm4)
 - [config/ltoptions.m4](#configltoptionsm4)
 - [config/ltmain.sh](#configltmainsh)
 - [src/cppunit/UnixDynamicLibraryManager.cpp](#srccppunitunixdynamiclibrarymanagercpp)
...
{% raw %}
64 | # check for dlopen,dlsym... or shl_load, shl_findsym...
{% endraw %}
...
22 | 	[dlopen(0, 0);],
25 | 	[AC_CHECK_LIB([svld], [dlopen],
40 | if test "x$ac_cv_func_dlopen" = xyes || test "x$ac_cv_lib_dl_dlopen" = xyes; then
{% endraw %}
...
{% raw %}
15 |   return ::dlopen( libraryName.c_str(), RTLD_NOW | RTLD_GLOBAL );
{% endraw %}

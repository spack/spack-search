...
11 / 1080 files match
 ...
 - [config/hwloc.m4](#confighwlocm4)
 - [config/ltmain.sh](#configltmainsh)
 - [src/components.c](#srccomponentsc)
 - [include/hwloc/plugins.h](#includehwlocpluginsh)
 - [contrib/hwloc-valgrind.supp](#contribhwloc-valgrindsupp)
 - [doc/doxygen-doc/html/a00158_source.html](#docdoxygen-dochtmla00158_sourcehtml)
 - [doc/doxygen-doc/html/a00203.html](#docdoxygen-dochtmla00203html)
 - [doc/doxygen-doc/man/man3/hwlocality_components_core_funcs.3](#docdoxygen-docmanman3hwlocality_components_core_funcs3)
...
{% raw %}
1091 |       AC_CHECK_LIB([ltdl], [lt_dlopenext],
1347 |   save_lt_cv_dlopen="$lt_cv_dlopen"
1348 |   save_lt_cv_dlopen_libs="$lt_cv_dlopen_libs"
1349 |   save_lt_cv_dlopen_self="$lt_cv_dlopen_self"
1351 |   # code stolen from LT_SYS_DLOPEN_SELF in libtool.m4
1354 |     lt_cv_dlopen="load_add_on"
1355 |     lt_cv_dlopen_libs=
1356 |     lt_cv_dlopen_self=yes
1360 |     lt_cv_dlopen="LoadLibrary"
1361 |     lt_cv_dlopen_libs=
1365 |     lt_cv_dlopen="dlopen"
1366 |     lt_cv_dlopen_libs=
1371 |     AC_CHECK_LIB([dl], [dlopen],
1372 |                 [lt_cv_dlopen="dlopen" lt_cv_dlopen_libs="-ldl"],[
1373 |     lt_cv_dlopen="dyld"
1374 |     lt_cv_dlopen_libs=
1375 |     lt_cv_dlopen_self=yes
1381 |           [lt_cv_dlopen="shl_load"],
1383 |             [lt_cv_dlopen="shl_load" lt_cv_dlopen_libs="-ldld"],
1384 |         [AC_CHECK_FUNC([dlopen],
1385 |               [lt_cv_dlopen="dlopen"],
1386 |           [AC_CHECK_LIB([dl], [dlopen],
1387 |                 [lt_cv_dlopen="dlopen" lt_cv_dlopen_libs="-ldl"],
1388 |             [AC_CHECK_LIB([svld], [dlopen],
1389 |                   [lt_cv_dlopen="dlopen" lt_cv_dlopen_libs="-lsvld"],
1391 |                     [lt_cv_dlopen="dld_link" lt_cv_dlopen_libs="-ldld"])
1399 |   # end of code stolen from LT_SYS_DLOPEN_SELF in libtool.m4
1402 |   HWLOC_LIBS_PRIVATE="$HWLOC_LIBS_PRIVATE $lt_cv_dlopen_libs"
1405 |   lt_cv_dlopen="$save_lt_cv_dlopen"
1406 |   lt_cv_dlopen_libs="$save_lt_cv_dlopen_libs"
1407 |   lt_cv_dlopen_self="$save_lt_cv_dlopen_self"
{% endraw %}
...
```
### doc/doxygen-doc/html/a00158_source.html
...
```
### doc/doxygen-doc/html/a00203.html
...
```
### doc/doxygen-doc/man/man3/hwlocality_components_core_funcs.3

```

{% raw %}
103 | Plugins should call this function in their init() callback to avoid later crashes if lazy symbol resolution is used by the upper layer that loaded hwloc (e\&.g\&. OpenCL implementations using dlopen with RTLD_LAZY)\&.
{% endraw %}

...
{% raw %}
267 | check_library_exists_concat("dl"     dlopen       HAVE_LIBDL)
495 | # Check for symbol dlopen (same as HAVE_LIBDL)
496 | check_library_exists("${CURL_LIBS}" dlopen "" HAVE_DLOPEN)
{% endraw %}

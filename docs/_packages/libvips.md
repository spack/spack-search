...
name: "libvips"
layout: package
next_package: libibumad
previous_package: netgen
languages: ['cpp', 'bash']
---
## 8.9.1
5 / 832 files match
 ...
 - [libvips/deprecated/package.c](#libvipsdeprecatedpackagec)
...
{% raw %}
2418 | # _LT_TRY_DLOPEN_SELF (ACTION-IF-TRUE, ACTION-IF-TRUE-W-USCORE,
2421 | m4_defun([_LT_TRY_DLOPEN_SELF],
2479 |   void *self = dlopen (0, LT_DLGLOBAL|LT_DLLAZY_OR_NOW);
2512 | ])# _LT_TRY_DLOPEN_SELF
2515 | # LT_SYS_DLOPEN_SELF
2517 | AC_DEFUN([LT_SYS_DLOPEN_SELF],
2519 | if test yes != "$enable_dlopen"; then
2520 |   enable_dlopen=unknown
2521 |   enable_dlopen_self=unknown
2522 |   enable_dlopen_self_static=unknown
2524 |   lt_cv_dlopen=no
2525 |   lt_cv_dlopen_libs=
2529 |     lt_cv_dlopen=load_add_on
2530 |     lt_cv_dlopen_libs=
2531 |     lt_cv_dlopen_self=yes
2535 |     lt_cv_dlopen=LoadLibrary
2536 |     lt_cv_dlopen_libs=
2540 |     lt_cv_dlopen=dlopen
2541 |     lt_cv_dlopen_libs=
2546 |     AC_CHECK_LIB([dl], [dlopen],
2547 | 		[lt_cv_dlopen=dlopen lt_cv_dlopen_libs=-ldl],[
2548 |     lt_cv_dlopen=dyld
2549 |     lt_cv_dlopen_libs=
2550 |     lt_cv_dlopen_self=yes
2557 |     lt_cv_dlopen=dlopen
2558 |     lt_cv_dlopen_libs=
2559 |     lt_cv_dlopen_self=no
2564 | 	  [lt_cv_dlopen=shl_load],
2566 | 	    [lt_cv_dlopen=shl_load lt_cv_dlopen_libs=-ldld],
2567 | 	[AC_CHECK_FUNC([dlopen],
2568 | 	      [lt_cv_dlopen=dlopen],
2569 | 	  [AC_CHECK_LIB([dl], [dlopen],
2570 | 		[lt_cv_dlopen=dlopen lt_cv_dlopen_libs=-ldl],
2571 | 	    [AC_CHECK_LIB([svld], [dlopen],
2572 | 		  [lt_cv_dlopen=dlopen lt_cv_dlopen_libs=-lsvld],
2574 | 		    [lt_cv_dlopen=dld_link lt_cv_dlopen_libs=-ldld])
2583 |   if test no = "$lt_cv_dlopen"; then
2584 |     enable_dlopen=no
2586 |     enable_dlopen=yes
2589 |   case $lt_cv_dlopen in
2590 |   dlopen)
2598 |     LIBS="$lt_cv_dlopen_libs $LIBS"
2600 |     AC_CACHE_CHECK([whether a program can dlopen itself],
2601 | 	  lt_cv_dlopen_self, [dnl
2602 | 	  _LT_TRY_DLOPEN_SELF(
2603 | 	    lt_cv_dlopen_self=yes, lt_cv_dlopen_self=yes,
2604 | 	    lt_cv_dlopen_self=no, lt_cv_dlopen_self=cross)
2607 |     if test yes = "$lt_cv_dlopen_self"; then
2609 |       AC_CACHE_CHECK([whether a statically linked program can dlopen itself],
2610 | 	  lt_cv_dlopen_self_static, [dnl
2611 | 	  _LT_TRY_DLOPEN_SELF(
2612 | 	    lt_cv_dlopen_self_static=yes, lt_cv_dlopen_self_static=yes,
2613 | 	    lt_cv_dlopen_self_static=no,  lt_cv_dlopen_self_static=cross)
2623 |   case $lt_cv_dlopen_self in
2624 |   yes|no) enable_dlopen_self=$lt_cv_dlopen_self ;;
2625 |   *) enable_dlopen_self=unknown ;;
2628 |   case $lt_cv_dlopen_self_static in
2629 |   yes|no) enable_dlopen_self_static=$lt_cv_dlopen_self_static ;;
2630 |   *) enable_dlopen_self_static=unknown ;;
2633 | _LT_DECL([dlopen_support], [enable_dlopen], [0],
2634 | 	 [Whether dlopen is supported])
2635 | _LT_DECL([dlopen_self], [enable_dlopen_self], [0],
2636 | 	 [Whether dlopen of programs is supported])
2637 | _LT_DECL([dlopen_self_static], [enable_dlopen_self_static], [0],
2638 | 	 [Whether dlopen of statically linked programs is supported])
2639 | ])# LT_SYS_DLOPEN_SELF
2642 | AU_ALIAS([AC_LIBTOOL_DLOPEN_SELF], [LT_SYS_DLOPEN_SELF])
2644 | dnl AC_DEFUN([AC_LIBTOOL_DLOPEN_SELF], [])
6745 |     [Compiler flag to allow reflexive dlopens])
6854 |   LT_SYS_DLOPEN_SELF
9049 |   _LT_UNLESS_OPTIONS([LT_INIT], [dlopen], [enable_dlopen=no
9083 | # dlopen
9085 | LT_OPTION_DEFINE([LT_INIT], [dlopen], [enable_dlopen=yes
9088 | AU_DEFUN([AC_LIBTOOL_DLOPEN],
9089 | [_LT_SET_OPTION([LT_INIT], [dlopen])
9092 | put the 'dlopen' option into LT_INIT's first parameter.])
9096 | dnl AC_DEFUN([AC_LIBTOOL_DLOPEN], [])
9610 | m4_ifndef([_LT_AC_TRY_DLOPEN_SELF],	[AC_DEFUN([_LT_AC_TRY_DLOPEN_SELF])])
{% endraw %}
...
{% raw %}
5 |  *	- now uses g_module_*() instead of dlopen()
{% endraw %}

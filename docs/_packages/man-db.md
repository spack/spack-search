...
previous_package: teckit
languages: ['bash']
---
## 2.7.6.1
5 / 726 files match

 - [src/tests/testlib.sh](#srcteststestlibsh)
 - [gnulib/m4/libtool.m4](#gnulibm4libtoolm4)
 - [gnulib/m4/ltoptions.m4](#gnulibm4ltoptionsm4)
...
{% raw %}
28 | 		-dlopen "$abs_top_builddir/lib/.libs/libman.la" \
29 | 		-dlopen "$abs_top_builddir/libdb/.libs/libmandb.la" \
{% endraw %}

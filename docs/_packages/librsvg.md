...
name: "librsvg"
layout: package
next_package: oniguruma
previous_package: clustal-omega
languages: ['bash']
---
## 2.50.0
8 / 10533 files match
 ...
 - [vendor/libc/src/vxworks/mod.rs](#vendorlibcsrcvxworksmodrs)
 - [vendor/libc/src/fuchsia/mod.rs](#vendorlibcsrcfuchsiamodrs)
 - [vendor/libc/src/unix/mod.rs](#vendorlibcsrcunixmodrs)
...
{% raw %}
97 | # Check if -ldl is needed to use dlopen()
98 | AC_CHECK_FUNC(dlopen, [],
99 |               [AC_CHECK_LIB(dl, dlopen, [DLOPEN_LIBS=-ldl])])
100 | AC_SUBST(DLOPEN_LIBS)
{% endraw %}
...
{% raw %}
1309 |     #[link_name = "_rtld_dlopen"]
1310 |     pub fn dlopen(filename: *const ::c_char, flag: ::c_int) -> *mut ::c_void;
{% endraw %}
...
{% raw %}
3882 |     pub fn dlopen(filename: *const ::c_char, flag: ::c_int) -> *mut ::c_void;
{% endraw %}
...
{% raw %}
1252 |     pub fn dlopen(filename: *const ::c_char, flag: ::c_int) -> *mut ::c_void;
{% endraw %}

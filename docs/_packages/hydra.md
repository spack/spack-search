...
14 / 770 files match
 ...
 - [tools/topo/hwloc/hwloc/configure.ac](#toolstopohwlochwlocconfigureac)
 - [tools/topo/hwloc/hwloc/config/libtool.m4](#toolstopohwlochwlocconfiglibtoolm4)
 - [tools/topo/hwloc/hwloc/config/ltoptions.m4](#toolstopohwlochwlocconfigltoptionsm4)
 - [tools/topo/hwloc/hwloc/config/hwloc.m4](#toolstopohwlochwlocconfighwlocm4)
 - [tools/topo/hwloc/hwloc/config/ltmain.sh](#toolstopohwlochwlocconfigltmainsh)
 ...
 - [tools/topo/hwloc/hwloc/contrib/hwloc-valgrind.supp](#toolstopohwlochwloccontribhwloc-valgrindsupp)
 - [confdb/libtool.m4](#confdblibtoolm4)
 - [confdb/ltoptions.m4](#confdbltoptionsm4)
 - [confdb/ltmain.sh](#confdbltmainsh)
 - [mpl/confdb/libtool.m4](#mplconfdblibtoolm4)
 - [mpl/confdb/ltoptions.m4](#mplconfdbltoptionsm4)
 - [mpl/confdb/ltmain.sh](#mplconfdbltmainsh)

### tools/topo/hwloc/hwloc/configure.ac
...
```
### tools/topo/hwloc/hwloc/config/hwloc.m4

```

{% raw %}
1044 |       AC_CHECK_LIB([ltdl], [lt_dlopenext],
1295 |   save_lt_cv_dlopen="$lt_cv_dlopen"
1296 |   save_lt_cv_dlopen_libs="$lt_cv_dlopen_libs"
1297 |   save_lt_cv_dlopen_self="$lt_cv_dlopen_self"
1299 |   # code stolen from LT_SYS_DLOPEN_SELF in libtool.m4
1302 |     lt_cv_dlopen="load_add_on"
1303 |     lt_cv_dlopen_libs=
1304 |     lt_cv_dlopen_self=yes
1308 |     lt_cv_dlopen="LoadLibrary"
1309 |     lt_cv_dlopen_libs=
1313 |     lt_cv_dlopen="dlopen"
1314 |     lt_cv_dlopen_libs=
1319 |     AC_CHECK_LIB([dl], [dlopen],
1320 |                 [lt_cv_dlopen="dlopen" lt_cv_dlopen_libs="-ldl"],[
1321 |     lt_cv_dlopen="dyld"
1322 |     lt_cv_dlopen_libs=
1323 |     lt_cv_dlopen_self=yes
1329 |           [lt_cv_dlopen="shl_load"],
1331 |             [lt_cv_dlopen="shl_load" lt_cv_dlopen_libs="-ldld"],
1332 |         [AC_CHECK_FUNC([dlopen],
1333 |               [lt_cv_dlopen="dlopen"],
1334 |           [AC_CHECK_LIB([dl], [dlopen],
1335 |                 [lt_cv_dlopen="dlopen" lt_cv_dlopen_libs="-ldl"],
1336 |             [AC_CHECK_LIB([svld], [dlopen],
1337 |                   [lt_cv_dlopen="dlopen" lt_cv_dlopen_libs="-lsvld"],
1339 |                     [lt_cv_dlopen="dld_link" lt_cv_dlopen_libs="-ldld"])
1347 |   # end of code stolen from LT_SYS_DLOPEN_SELF in libtool.m4
1350 |   HWLOC_LIBS_PRIVATE="$HWLOC_LIBS_PRIVATE $lt_cv_dlopen_libs"
1353 |   lt_cv_dlopen="$save_lt_cv_dlopen"
1354 |   lt_cv_dlopen_libs="$save_lt_cv_dlopen_libs"
1355 |   lt_cv_dlopen_self="$save_lt_cv_dlopen_self"
{% endraw %}
...
```
### tools/topo/hwloc/hwloc/contrib/hwloc-valgrind.supp

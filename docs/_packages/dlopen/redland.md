...
---
## 1.0.17
19 / 319 files match, 7 filtered matches.

 - [src/rdf_storage.c](#srcrdf_storagec)
...
{% raw %}
277 |   typedef void init_func_t(librdf_world*);
278 |   init_func_t* init;
279 |   
280 |   lt_dlhandle module = lt_dlopenext(lib_name);
281 | 
282 |   if(module) {
{% endraw %}

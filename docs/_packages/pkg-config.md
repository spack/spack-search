...
6 / 349 files match
 ...
 - [glib/configure.ac](#glibconfigureac)
 - [glib/ltmain.sh](#glibltmainsh)
 - [glib/m4macros/libtool.m4](#glibm4macroslibtoolm4)
 - [glib/m4macros/ltoptions.m4](#glibm4macrosltoptionsm4)
...
{% raw %}
1517 | dnl *** dlopen() filepath must be of the form /path/libname.a(libname.so)
1523 | dnl *** dlopen() and dlsym() in system libraries
1525 | 	AC_CHECK_FUNC(dlopen,
1546 | dnl *** dlopen() and dlsym() in libdl
1548 | 	AC_CHECK_LIB(dl, dlopen,
1590 |     handle = dlopen ("./$objdir/plugin.o", RTLD_GLOBAL | RTLD_LAZY);
1613 | 		  handle = dlopen ((void*)0, 0);
{% endraw %}

...
{% raw %}
245 | #~ msgid "System dlopen failed"
246 | #~ msgstr "Selhalo volání systému dlopen"
{% endraw %}
...
{% raw %}
243 | #~ msgid "System dlopen failed"
244 | #~ msgstr "系统 dlopen 失败"
{% endraw %}
...
{% raw %}
248 | #~ msgid "System dlopen failed"
249 | #~ msgstr "Помилка системного dlopen"
{% endraw %}
...
{% raw %}
248 | #~ msgid "System dlopen failed"
249 | #~ msgstr "dlopen sustava nije uspio"
{% endraw %}
...
{% raw %}
247 | #~ msgid "System dlopen failed"
{% endraw %}
...
{% raw %}
254 | #~ msgid "System dlopen failed"
255 | #~ msgstr "De dlopen()-systeemfunctie is mislukt"
{% endraw %}
...
{% raw %}
253 | #~ msgid "System dlopen failed"
254 | #~ msgstr "Lỗi dlopen hệ thống"
{% endraw %}
...
{% raw %}
246 | #~ msgid "System dlopen failed"
247 | #~ msgstr "Misslyckades med systemanrop dlopen"
{% endraw %}
...
{% raw %}
257 | #~ msgid "System dlopen failed"
258 | #~ msgstr "Järjestelmän dlopen-käsky ei onnistunut"
{% endraw %}
...
{% raw %}
247 | #~ msgid "System dlopen failed"
248 | #~ msgstr "dlopen de sistema falhou"
{% endraw %}
...
{% raw %}
251 | #~ msgid "System dlopen failed"
252 | #~ msgstr "Malsukcesis sistemfunkcio 'dlopen()'"
{% endraw %}
...
{% raw %}
248 | #~ msgid "System dlopen failed"
249 | #~ msgstr "Sistem dlopen gagal"
{% endraw %}
...
{% raw %}
252 | #~ msgid "System dlopen failed"
253 | #~ msgstr "System-dlopen fehlgeschlagen"
{% endraw %}

...
12 / 1990 files match
 ...
 - [build-config/ltmain.sh](#build-configltmainsh)
 - [build-config/m4/scorep_dlfcn.m4](#build-configm4scorep_dlfcnm4)
 ...
 - [vendor/common/build-config/m4/libtool.m4](#vendorcommonbuild-configm4libtoolm4)
 - [vendor/common/build-config/m4/ltoptions.m4](#vendorcommonbuild-configm4ltoptionsm4)
 - [vendor/otf2/build-config/ltmain.sh](#vendorotf2build-configltmainsh)
 - [vendor/otf2/build-config/m4/libtool.m4](#vendorotf2build-configm4libtoolm4)
 - [vendor/otf2/build-config/m4/ltoptions.m4](#vendorotf2build-configm4ltoptionsm4)
 - [vendor/opari2/build-config/ltmain.sh](#vendoropari2build-configltmainsh)
 - [vendor/opari2/vendor/common/build-config/m4/libtool.m4](#vendoropari2vendorcommonbuild-configm4libtoolm4)
 - [vendor/opari2/vendor/common/build-config/m4/ltoptions.m4](#vendoropari2vendorcommonbuild-configm4ltoptionsm4)
...
```
### build-config/m4/scorep_dlfcn.m4

```

{% raw %}
56 | AC_CHECK_LIB([dl],[dlopen],[],[have_dlfcn_functions="no"])
{% endraw %}
...
{% raw %}
235 |         /* Handle from dlopen() */
239 |         /* String with error message if there is a problem while dlopen() */
307 |             /* Now use dlopen to load dynamic library
...
142 |                 UTILS_ERROR( SCOREP_ERROR_DLOPEN_FAILED,
{% endraw %}

```
### vendor/common/build-config/m4/libtool.m4
...
5748 |   LT_SYS_DLOPEN_SELF
{% endraw %}

```
### vendor/common/build-config/m4/ltoptions.m4
...
```
### vendor/otf2/build-config/ltmain.sh
...
```
### vendor/otf2/build-config/m4/libtool.m4
...
```
### vendor/otf2/build-config/m4/ltoptions.m4
...
```
### vendor/opari2/build-config/ltmain.sh
...
```
### vendor/opari2/vendor/common/build-config/m4/libtool.m4
...
```
### vendor/opari2/vendor/common/build-config/m4/ltoptions.m4

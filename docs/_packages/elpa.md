...
7 / 412 files match
 ...
 - [test_project_2stage_legacy_api/m4/libtool.m4](#test_project_2stage_legacy_apim4libtoolm4)
 - [test_project_2stage_legacy_api/m4/ltoptions.m4](#test_project_2stage_legacy_apim4ltoptionsm4)
...
{% raw %}
701 | # the dlopen flags are needed for MKL to work properly...
703 | 	@echo "$(wrapper) $(PYTHON) -c 'import sys, os; sys.setdlopenflags(os.RTLD_NOW | os.RTLD_GLOBAL); import pytest; sys.exit(pytest.main([\"./python-copy\", \"-p\", \"no:cacheprovider\"]))'" >> $@
{% endraw %}
...
{% raw %}
23098 | # the dlopen flags are needed for MKL to work properly...
23100 | 	@echo "$(wrapper) $(PYTHON) -c 'import sys, os; sys.setdlopenflags(os.RTLD_NOW | os.RTLD_GLOBAL); import pytest; sys.exit(pytest.main([\"./python-copy\", \"-p\", \"no:cacheprovider\"]))'" >> $@
{% endraw %}

```
### test_project_2stage_legacy_api/m4/libtool.m4
...
6234 |   LT_SYS_DLOPEN_SELF
{% endraw %}

```
### test_project_2stage_legacy_api/m4/ltoptions.m4

...
5289 |     [Compiler flag to allow reflexive dlopens])
5401 |   LT_SYS_DLOPEN_SELF
7526 |   _LT_UNLESS_OPTIONS([LT_INIT], [dlopen], [enable_dlopen=no
7558 | # dlopen
7560 | LT_OPTION_DEFINE([LT_INIT], [dlopen], [enable_dlopen=yes
7563 | AU_DEFUN([AC_LIBTOOL_DLOPEN],
7564 | [_LT_SET_OPTION([LT_INIT], [dlopen])
7567 | put the `dlopen' option into LT_INIT's first parameter.])
7571 | dnl AC_DEFUN([AC_LIBTOOL_DLOPEN], [])
8017 | m4_ifndef([_LT_AC_TRY_DLOPEN_SELF],	[AC_DEFUN([_LT_AC_TRY_DLOPEN_SELF])])
{% endraw %}

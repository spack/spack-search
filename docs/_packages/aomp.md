...
322 | 	if ((dlerr = dlerror())){
323 | 		_print(dlerr, 0);
1165 |  * Binds Python function names to C functions.
1166 |  */
1167 | static PyMethodDef ompdModule_methods[] = {
1168 | 	{"ompd_open", ompd_open, METH_VARARGS, "Execute dlopen, return OMPD version."},
1169 | 	{"call_ompd_initialize", call_ompd_initialize, METH_NOARGS, "Initializes OMPD environment and callbacks."},
1170 | 	{"call_ompd_rel_thread_handle", call_ompd_rel_thread_handle, METH_VARARGS, "Releases a thread handle."},
{% endraw %}

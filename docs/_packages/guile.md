...
12 / 2069 files match
 ...
 - [meta/build-env.in](#metabuild-envin)
 - [meta/uninstalled-env.in](#metauninstalled-envin)
 ...
 - [doc/ref/api-evaluation.texi](#docrefapi-evaluationtexi)
 - [doc/ref/api-foreign.texi](#docrefapi-foreigntexi)
 - [doc/ref/guile.info-4](#docrefguileinfo-4)
...
111 |   [lt_dlopenext ("foo");])
247 |       DLPREOPEN="$DLPREOPEN -dlopen $module"
{% endraw %}
...
{% raw %}
105 |     # Don't look in installed dirs for dlopen-able modules
{% endraw %}
...
{% raw %}
1184 | @code{dlopen} in C, consider @code{include} to be like the C
{% endraw %}
...
{% raw %}
61 | more technical term @dfn{dlopening}, as suggested by Gordon Matzigkeit
84 | lt_dlopenext, @code{lt_dlopenext}, libtool, Shared Library Support for
{% endraw %}
...
{% raw %}
3742 |    If you are a C programmer, if ‘load’ in Scheme is like ‘dlopen’ in C,
5639 |      automatically, according to libltdl’s rules (*note lt_dlopenext:
5683 | clear, it is probably best to use the more technical term “dlopening”,
{% endraw %}

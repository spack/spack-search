...
57 | #define RTLD_GLOBAL 4 /* symbols in this dlopen'ed obj are visible to other
58 |                        * dlopen'ed objs */
...
557 | #endif /* Windows emulation of dlopen, dlsym, and dlerr */
{% endraw %}
...
49 | #define RTLD_GLOBAL	4	/* symbols in this dlopen'ed obj are visible to other dlopen'ed objs */

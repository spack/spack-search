...
18 / 1484 files match
 ...
 - [config/ax_lua.m4](#configax_luam4)
 ...
 - [src/common/libflux/module.h](#srccommonlibfluxmoduleh)
 - [src/common/libflux/plugin.c](#srccommonlibfluxpluginc)
 - [src/common/libflux/test/plugin.c](#srccommonlibfluxtestpluginc)
 - [src/common/libpmi/pmi2.c](#srccommonlibpmipmi2c)
 - [src/common/libpmi/pmi.c](#srccommonlibpmipmic)
 ...
 - [src/broker/test/pmiutil.c](#srcbrokertestpmiutilc)
 - [t/valgrind/valgrind.supp](#tvalgrindvalgrindsupp)
...
{% raw %}
172 | via the `PMI_FD` environment variable, or by dlopening a PMI library.
182 | a `libpmi.so` library that can be dlopened.
{% endraw %}
...
```
### src/common/libflux/module.h

```cpp

{% raw %}
45 |  * If 'cb' is non-NULL, any dlopen/dlsym errors are reported via callback.
52 |  * If 'cb' is non-NULL, any dlopen/dlsym errors are reported via callback.
{% endraw %}
...
```
### src/common/libpmi/pmi2.c

```cpp

{% raw %}
14 |  * --with-pmi=pmi2.  This configuration forces a dlopen of libpmi2.so.0.0.0,
{% endraw %}

```
### src/common/libpmi/pmi.c

```cpp

{% raw %}
14 |  * 2) dlopen() this library and use standard ABI
{% endraw %}
...
```
### src/broker/test/pmiutil.c

```cpp

{% raw %}
35 |      * and dlopen will fail
{% endraw %}

...
16 / 1293 files match
 ...
 - [ChangeLog.2004](#changelog2004)
 - [config/ltmain.sh](#configltmainsh)
 - [m4/libtool.m4](#m4libtoolm4)
 - [m4/ltoptions.m4](#m4ltoptionsm4)
 - [TclMagick/unix/config/ltmain.sh](#tclmagickunixconfigltmainsh)
 - [TclMagick/unix/m4/libtool.m4](#tclmagickunixm4libtoolm4)
 - [TclMagick/unix/m4/ltoptions.m4](#tclmagickunixm4ltoptionsm4)
 - [www/ChangeLog-2016.rst](#wwwchangelog-2016rst)
 - [www/ChangeLog-2004.html](#wwwchangelog-2004html)
 - [www/ChangeLog-2004.rst](#wwwchangelog-2004rst)
 - [www/ChangeLog-2016.html](#wwwchangelog-2016html)
 - [magick/nt_base.h](#magicknt_baseh)
...
1786 | # If profiling, then check for -ldl and dlopen (required for Solaris & gcc)
1791 |   AC_CHECK_LIB(dl,dlopen,LIB_DL='-ldl',,)
{% endraw %}
...
{% raw %}
11 | 	without depending on dlopen() with RTLD_GLOBAL behavior.
{% endraw %}
...
{% raw %}
135 | 	* magick/nt_base.c (lt_dlopen): Handle errors while loading
{% endraw %}
...
```
### TclMagick/unix/config/ltmain.sh
...
```
### TclMagick/unix/m4/ltoptions.m4
...
```
### www/ChangeLog-2016.rst

```

{% raw %}
11 |     without depending on dlopen() with RTLD\_GLOBAL behavior.
{% endraw %}
...
{% raw %}
193 | <li>magick/nt_base.c (lt_dlopen): Handle errors while loading
{% endraw %}

```
### www/ChangeLog-2004.rst

```

{% raw %}
135 |   - magick/nt\_base.c (lt\_dlopen): Handle errors while loading
{% endraw %}
...
{% raw %}
48 | without depending on dlopen() with RTLD_GLOBAL behavior.</li>
{% endraw %}
...
{% raw %}
433 |   *NTdlopen(const char *filename),
449 | #define lt_dlopen(filename) NTdlopen(filename)
{% endraw %}

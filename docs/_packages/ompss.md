...
10 / 4111 files match
 ...
 - [nanox-0.7.4/ltmain.sh](#nanox-074ltmainsh)
 - [nanox-0.7.4/src/arch/unix-os/os.cpp](#nanox-074srcarchunix-ososcpp)
 - [nanox-0.7.4/src/utils/nanox.cpp](#nanox-074srcutilsnanoxcpp)
 - [nanox-0.7.4/m4/libtool.m4](#nanox-074m4libtoolm4)
 - [nanox-0.7.4/m4/ltoptions.m4](#nanox-074m4ltoptionsm4)
 - [mcxx-1.99.4/ltmain.sh](#mcxx-1994ltmainsh)
 - [mcxx-1.99.4/src/mcxx_tl/cxx-compilerphases.cpp](#mcxx-1994srcmcxx_tlcxx-compilerphasescpp)
 - [mcxx-1.99.4/src/driver/cxx-driver.c](#mcxx-1994srcdrivercxx-driverc)
 - [mcxx-1.99.4/m4/libtool.m4](#mcxx-1994m4libtoolm4)
 - [mcxx-1.99.4/m4/ltoptions.m4](#mcxx-1994m4ltoptionsm4)

### nanox-0.7.4/ltmain.sh
...
```
### nanox-0.7.4/src/arch/unix-os/os.cpp

```

{% raw %}
81 |    return dlopen ( filename.c_str(), RTLD_NOW );
{% endraw %}

```
### nanox-0.7.4/src/utils/nanox.cpp

```

{% raw %}
60 |             handle = dlopen( (std::string(PLUGIN_DIR) + std::string("/") + name).c_str(), RTLD_LOCAL | RTLD_LAZY);
{% endraw %}

```
### nanox-0.7.4/m4/libtool.m4
...
```
### mcxx-1.99.4/src/mcxx_tl/cxx-compilerphases.cpp

```

{% raw %}
473 |         void* handle = dlopen(library_name, RTLD_NOW | RTLD_GLOBAL);
{% endraw %}

```
### mcxx-1.99.4/src/driver/cxx-driver.c

```cpp

{% raw %}
4733 |     // This invokes a C++ routine that will dlopen all libraries, get the proper symbol
{% endraw %}

```
### mcxx-1.99.4/m4/libtool.m4

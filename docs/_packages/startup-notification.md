...
5732 |   LT_SYS_DLOPEN_SELF
7927 |   _LT_UNLESS_OPTIONS([LT_INIT], [dlopen], [enable_dlopen=no
7959 | # dlopen
7961 | LT_OPTION_DEFINE([LT_INIT], [dlopen], [enable_dlopen=yes
7964 | AU_DEFUN([AC_LIBTOOL_DLOPEN],
7965 | [_LT_SET_OPTION([LT_INIT], [dlopen])
7968 | put the `dlopen' option into LT_INIT's first parameter.])
7972 | dnl AC_DEFUN([AC_LIBTOOL_DLOPEN], [])
8418 | m4_ifndef([_LT_AC_TRY_DLOPEN_SELF],	[AC_DEFUN([_LT_AC_TRY_DLOPEN_SELF])])
{% endraw %}

...
{% raw %}
134 | dnl dlopen support is optional
135 | AC_ARG_WITH([dlopen],
136 | 	AC_HELP_STRING([--with-dlopen],
141 | AS_IF([test x"$with_dlopen" != x"no"], [
142 | AC_CHECK_LIB(dl, dlopen, [],
143 |     AC_MSG_ERROR([dlopen not found.  libfabric requires libdl.]))
{% endraw %}

...
layout: package
next_package: libnl
previous_package: kim-api
languages: ['bash']
---
## 1.4.0
5 / 661 files match

 - [src/libsodium/configure.ac](#srclibsodiumconfigureac)
 - [src/libsodium/ltmain.sh](#srclibsodiumltmainsh)
 - [src/libsodium/m4/libtool.m4](#srclibsodiumm4libtoolm4)
 - [src/libsodium/m4/ltoptions.m4](#srclibsodiumm4ltoptionsm4)
 - [src/libsodium/build-aux/ltmain.sh](#srclibsodiumbuild-auxltmainsh)

### src/libsodium/configure.ac
...
```
### src/libsodium/build-aux/ltmain.sh

...
6 / 362 files match
 ...
 - [src/libbsd.map](#srclibbsdmap)
 - [src/libbsd-ctor.pc.in](#srclibbsd-ctorpcin)
 - [src/setproctitle_ctor.c](#srcsetproctitle_ctorc)
...
{% raw %}
109 |     /* Exported to cope with the constructor+dlopen+threads mess. */
{% endraw %}
...
{% raw %}
10 | Libs: -L${libdir} -Wl,-z,nodlopen -Wl,-u,libbsd_init_func -lbsd-ctor
{% endraw %}
...
{% raw %}
33 |  * indirectly dlopen()ed during the execution of the program, which could
41 |  * linker flags will mark the program as not allowing to be dlopen()ed
{% endraw %}

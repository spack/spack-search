...
113 | AC_CHECK_FUNCS(strchr strlcpy snprintf dlopen)
129 | [if test X$ac_cv_func_dlopen = Xyes
{% endraw %}
...
{% raw %}
130 | /* Define to 1 if you have the `dlopen' function. */
131 | #undef HAVE_DLOPEN
{% endraw %}
...
79 | 	   extern void * dlopen(char const *,int);
{% endraw %}

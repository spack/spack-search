...
8593 | 	func_warning "\`-dlopen' is ignored for objects"
8711 |         && test "$dlopen_support" = unknown \
8712 | 	&& test "$dlopen_self" = unknown \
8713 | 	&& test "$dlopen_self_static" = unknown && \
8714 | 	  func_warning "\`LT_INIT([dlopen])' not used. Assuming no dlopen support."
9395 | # The name that we can dlopen(3).
9424 | # Files to dlopen/dlpreopen
9425 | dlopen='$dlfiles'
{% endraw %}

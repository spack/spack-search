...
layout: package
next_package: hydra
previous_package: intel-gpu-tools
languages: ['bash']
---
## 2.0.3
4 / 221 files match
...
1724 | dlopen_support=$enable_dlopen
1726 | # Whether dlopen of programs is supported.
1727 | dlopen_self=$enable_dlopen_self
1729 | # Whether dlopen of statically linked programs is supported.
1730 | dlopen_self_static=$enable_dlopen_self_static
1777 | # Compiler flag to allow reflexive dlopens.
{% endraw %}

...
8066 |   _LT_UNLESS_OPTIONS([LT_INIT], [dlopen], [enable_dlopen=no
8098 | # dlopen
8100 | LT_OPTION_DEFINE([LT_INIT], [dlopen], [enable_dlopen=yes
8103 | AU_DEFUN([AC_LIBTOOL_DLOPEN],
8104 | [_LT_SET_OPTION([LT_INIT], [dlopen])
8107 | put the `dlopen' option into LT_INIT's first parameter.])
8111 | dnl AC_DEFUN([AC_LIBTOOL_DLOPEN], [])
8572 | m4_ifndef([_LT_AC_TRY_DLOPEN_SELF],	[AC_DEFUN([_LT_AC_TRY_DLOPEN_SELF])])
{% endraw %}

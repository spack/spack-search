...
8 / 2777 files match
 ...
 - [bridge/gbgetsymbol.cpp](#bridgegbgetsymbolcpp)
 - [port/cplgetsymbol.cpp](#portcplgetsymbolcpp)
 - [m4/libtool.m4](#m4libtoolm4)
 - [m4/ltoptions.m4](#m4ltoptionsm4)
 - [m4/lib-link.m4](#m4lib-linkm4)
 - [gcore/gdaldllmain.cpp](#gcoregdaldllmaincpp)
...
```
### bridge/gbgetsymbol.cpp

```

{% raw %}
60 |     pLibrary = dlopen(pszLibrary, RTLD_LAZY);
{% endraw %}
...
89 |     pLibrary = dlopen(pszLibrary, RTLD_LAZY);
{% endraw %}
...
{% raw %}
55 | /* Called when GDAL is loaded by loader or by dlopen(),                 */
56 | /* and before dlopen() returns.                                         */
{% endraw %}

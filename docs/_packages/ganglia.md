...
5 / 360 files match
 ...
 - [libmetrics/aclocal.m4](#libmetricsaclocalm4)
 - [libmetrics/build/ltmain.sh](#libmetricsbuildltmainsh)
...
8086 | # dlopen
8088 | LT_OPTION_DEFINE([LT_INIT], [dlopen], [enable_dlopen=yes
8091 | AU_DEFUN([AC_LIBTOOL_DLOPEN],
8092 | [_LT_SET_OPTION([LT_INIT], [dlopen])
8095 | put the `dlopen' option into LT_INIT's first parameter.])
8099 | dnl AC_DEFUN([AC_LIBTOOL_DLOPEN], [])
8560 | m4_ifndef([_LT_AC_TRY_DLOPEN_SELF],	[AC_DEFUN([_LT_AC_TRY_DLOPEN_SELF])])
{% endraw %}

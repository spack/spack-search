...
8 / 2976 files match
 ...
 - [src/H5PLpkg.h](#srch5plpkgh)
 - [m4/libtool.m4](#m4libtoolm4)
 - [m4/ltoptions.m4](#m4ltoptionsm4)
 - [release_docs/HISTORY-1_10.txt](#release_docshistory-1_10txt)
...
{% raw %}
964 | ## dlopen - This will use an improved version of libtool
966 | LT_INIT([dlopen,win32-dll])
1042 | AC_CHECK_LIB([dl], [dlopen])
{% endraw %}
...
{% raw %}
125 |   CHECK_LIBRARY_EXISTS_CONCAT ("dl" dlopen     ${HDF_PREFIX}_HAVE_LIBDL)
{% endraw %}
...
{% raw %}
329 |     - Changed the plugins dlopen option from RTLD_NOW to RTLD_LAZY
{% endraw %}

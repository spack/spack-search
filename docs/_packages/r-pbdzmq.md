...
layout: package
next_package: h5part
previous_package: graphite2
languages: ['bash']
---
## 0.3-3
5 / 359 files match

 - [src/zmqsrc/configure.ac](#srczmqsrcconfigureac)
 - [src/zmqsrc/config/libtool.m4](#srczmqsrcconfiglibtoolm4)
 - [src/zmqsrc/config/ltoptions.m4](#srczmqsrcconfigltoptionsm4)
 - [src/zmqsrc/config/ltmain.sh](#srczmqsrcconfigltmainsh)
 - [vignettes/pbdZMQ-include/99-faq.tex](#vignettespbdzmq-include99-faqtex)

### src/zmqsrc/configure.ac

```

{% raw %}
161 |         # dladdr/dlopen is in libdl on glibc
{% endraw %}

```
### src/zmqsrc/config/libtool.m4
...
```
### src/zmqsrc/config/ltoptions.m4
...
```
### vignettes/pbdZMQ-include/99-faq.tex

```

{% raw %}
18 | dlopen(/.../R/3.2/library/pbdZMQ/libs/pbdZMQ.so, 6):
{% endraw %}

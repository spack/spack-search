...
6691 |     [Compiler flag to allow reflexive dlopens])
6800 |   LT_SYS_DLOPEN_SELF
9072 |   _LT_UNLESS_OPTIONS([LT_INIT], [dlopen], [enable_dlopen=no
9104 | # dlopen
9106 | LT_OPTION_DEFINE([LT_INIT], [dlopen], [enable_dlopen=yes
9109 | AU_DEFUN([AC_LIBTOOL_DLOPEN],
9110 | [_LT_SET_OPTION([LT_INIT], [dlopen])
9113 | put the `dlopen' option into LT_INIT's first parameter.])
9117 | dnl AC_DEFUN([AC_LIBTOOL_DLOPEN], [])
9578 | m4_ifndef([_LT_AC_TRY_DLOPEN_SELF],	[AC_DEFUN([_LT_AC_TRY_DLOPEN_SELF])])
{% endraw %}

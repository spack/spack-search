...
11 / 4232 files match
 ...
 - [ChangeLog.pre-1.10](#changelogpre-110)
...
{% raw %}
29453 |     and we need to dlopen cairo ourselves. Similarly the linker is not able to
{% endraw %}
...
{% raw %}
746 | dnl Some utilities need to dlopen the shared libraries, so they need to
{% endraw %}

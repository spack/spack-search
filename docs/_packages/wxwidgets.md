...
previous_package: perl-alien-build
languages: ['cpp', 'bash']
---
## 3.1.0
15 / 7387 files match
 ...
 - [setup.h.in](#setuphin)
 - [setup.h_vms](#setuph_vms)
 - [configure.in](#configurein)
 - [src/expat/aclocal.m4](#srcexpataclocalm4)
 - [src/expat/m4/libtool.m4](#srcexpatm4libtoolm4)
 - [src/expat/m4/ltoptions.m4](#srcexpatm4ltoptionsm4)
 - [src/expat/conftools/ltmain.sh](#srcexpatconftoolsltmainsh)
 - [src/png/ltmain.sh](#srcpngltmainsh)
 - [src/png/scripts/libtool.m4](#srcpngscriptslibtoolm4)
 - [src/png/scripts/ltoptions.m4](#srcpngscriptsltoptionsm4)
 - [src/unix/dlunix.cpp](#srcunixdlunixcpp)
 - [src/tiff/config/ltmain.sh](#srctiffconfigltmainsh)
 - [src/tiff/m4/libtool.m4](#srctiffm4libtoolm4)
 - [src/tiff/m4/ltoptions.m4](#srctiffm4ltoptionsm4)
 - [include/wx/dynlib.h](#includewxdynlibh)
...
{% raw %}
1010 | /* Define if you have dlopen() */
1011 | #define HAVE_DLOPEN 1
{% endraw %}
...
{% raw %}
5179 |             dnl the test is a bit complicated because we check for dlopen() both with
5181 |             dnl dlopen() on this system
5182 |             AC_CHECK_FUNCS(dlopen,
5184 |                 AC_DEFINE(HAVE_DLOPEN)
5188 |                 AC_CHECK_LIB(dl, dlopen,
5190 |                                 AC_DEFINE(HAVE_DLOPEN)
5229 |             dnl dlopen/dlerror is implemented in dynlib.cpp for Darwin/Mac OS X
{% endraw %}
...
{% raw %}
1957 | # _LT_TRY_DLOPEN_SELF (ACTION-IF-TRUE, ACTION-IF-TRUE-W-USCORE,
1960 | m4_defun([_LT_TRY_DLOPEN_SELF],
2012 |   void *self = dlopen (0, LT_DLGLOBAL|LT_DLLAZY_OR_NOW);
2041 | ])# _LT_TRY_DLOPEN_SELF
2044 | # LT_SYS_DLOPEN_SELF
2046 | AC_DEFUN([LT_SYS_DLOPEN_SELF],
...
2154 | _LT_DECL([dlopen_support], [enable_dlopen], [0],
2155 | 	 [Whether dlopen is supported])
2156 | _LT_DECL([dlopen_self], [enable_dlopen_self], [0],
2157 | 	 [Whether dlopen of programs is supported])
2158 | _LT_DECL([dlopen_self_static], [enable_dlopen_self_static], [0],
2159 | 	 [Whether dlopen of statically linked programs is supported])
2160 | ])# LT_SYS_DLOPEN_SELF
2163 | AU_ALIAS([AC_LIBTOOL_DLOPEN_SELF], [LT_SYS_DLOPEN_SELF])
2165 | dnl AC_DEFUN([AC_LIBTOOL_DLOPEN_SELF], [])
5498 |     [Compiler flag to allow reflexive dlopens])
5610 |   LT_SYS_DLOPEN_SELF
7760 |   _LT_UNLESS_OPTIONS([LT_INIT], [dlopen], [enable_dlopen=no
7792 | # dlopen
7794 | LT_OPTION_DEFINE([LT_INIT], [dlopen], [enable_dlopen=yes
7797 | AU_DEFUN([AC_LIBTOOL_DLOPEN],
7798 | [_LT_SET_OPTION([LT_INIT], [dlopen])
7801 | put the `dlopen' option into LT_INIT's first parameter.])
7805 | dnl AC_DEFUN([AC_LIBTOOL_DLOPEN], [])
8251 | m4_ifndef([_LT_AC_TRY_DLOPEN_SELF],	[AC_DEFUN([_LT_AC_TRY_DLOPEN_SELF])])
{% endraw %}
...
{% raw %}
36 | #elif defined(HAVE_DLOPEN)
266 |     // Return the raw handle from dlopen and friends.
{% endraw %}
